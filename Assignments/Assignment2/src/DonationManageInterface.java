...
public interface DonationManageInterface {
	 ...
	 * ("Volunteer Queue is empty") if there are no volunteers
	 * ("Contain is empty") if the container is empty
	 * ("Recipient Queue is empty") if there are no recipients
	 * @throws VolunteerException
	 * @throws ContainerExcpetion
